(function () {
  var CART_KEY = "hightac-vmaxnewonline-cart-v1";
  var SUBMISSION_KEY = "hightac-vmaxnewonline-last-submission-v1";
  var LANG_KEY = "hightac-vmaxnewonline-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "VMAX",
        motorPicture: "Database/MotorPictures/VMAX.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "VMAX";
